...
const debug = require("debug")("storefront-ica-generator:StoreFrontService")
...
class StoreFrontService {
  constructor({ storeFrontUrl, desktop, domain, username, password, icaFilePath }) {
    ...
    debug('StoreFrontService', { storeFrontUrl, desktop, domain, username, password })
  ...
  writeICAFileContents(resource, callback) {
    if (!this.icaFilePath) return callback(new Error('StoreFrontService->writeICAFileContents: requires icaFilePath'))
